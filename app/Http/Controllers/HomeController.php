...
class HomeController extends Controller
{
    ...
    public function listRPP()
    {
        ...
        return view('kurikulum.document.list', compact('document'));
    }

    public function getRPP()
    {
        return view('kurikulum.document.add');
    }
    ...
    public function jadwalSupervisi()
    {
        $jadwalSupervisi = Jadwal::where('id_supervisor' ,'=',  Auth::user()->id)->get();
        return view('kurikulum.supervisor.index' , compact('jadwalSupervisi'));
    }
}
